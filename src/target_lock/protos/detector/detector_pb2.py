...
# source: target_lock/protos/detector/detector.proto
...
_runtime_version.ValidateProtobufRuntimeVersion(
    ...
    1,
    '',
    'target_lock/protos/detector/detector.proto'
)
